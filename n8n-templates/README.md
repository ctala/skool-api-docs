...
4. n8n.io → **Submit a workflow** (or in-app Share → publish to template library): paste the exported workflow, title, description, categories below.
5. After publish, add the n8n.io URL to the matching recipe page (like the auto-approve recipe links its template).
