...
- An [Apify account](https://apify.com?fpr=cristian) (free tier is enough to test). Grab your API token from [account → integrations](https://console.apify.com/sign-up?fpr=cristian).
